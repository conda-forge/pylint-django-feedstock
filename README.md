About pylint-django-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pylint-django-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pylint-django-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pylint-django-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pylint-django` can be installed with `conda`:
...
```
mamba install pylint-django
```

It is possible to list all of the versions of `pylint-django` available on your platform with `conda`:
...
```
mamba search pylint-django --channel conda-forge
```
...
mamba repoquery search pylint-django --channel conda-forge

# List packages depending on `pylint-django`:
mamba repoquery whoneeds pylint-django --channel conda-forge

# List dependencies of `pylint-django`:
mamba repoquery depends pylint-django --channel conda-forge
```
